...
export const mockTemplates: Template[] = [
  ...
  },
  {
    ...
    name: "Folio",
    category: "Minimal",
    description: "Single-column layout with crisp mono score treatment.",
    isPremium: false,
  },
  {
    id: "tpl_signal",
...
export const mockAISuggestions: AISuggestion[] = [
  ...
  },
  {
    ...
    severity: "critical",
    priority: "high",
    impact: "+8 resume score",
  },
  {
    id: "ai_4",
    section: "Experience",
    category: "Clarity",
    title: "Clarify section headings",
    body: "Clearer section headings help recruiters scan your CV faster.",
    ctaLabel: "Improve",
    severity: "improve",
    priority: "medium",
