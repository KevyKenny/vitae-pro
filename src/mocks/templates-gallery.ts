...
export const galleryTemplates: GalleryTemplate[] = [
  {
    ...
    atsLevel: "highly-optimized",
    atsScore: 96,
    rating: 4.9,
    reviews: 428,
    popularity: 98,
    badges: ["recommended", "ats-optimized", "recruiter-favorite"],
    isPremium: false,
    isFeatured: true,
    accent: "#1F4D3D",
    ...
    features: ["ATS-safe headings", "Skill chips", "Metric-forward bullets"],
    readability: 94,
  },
  {
    id: "tpl_ledger",
  ...
  },
  {
    ...
    name: "Cordial",
    description:
      "Friendly modern layout that stays ATS-safe while feeling warm and approachable.",
    style: "modern",
    ...
    features: ["Soft section labels", "Compact skills", "ATS vetted"],
    readability: 93,
  },
  {
    id: "tpl_foundry",
  ...
  },
  {
    ...
    name: "Halcyon",
    description:
      "Minimal single-column resume that scanners and ATS engines love.",
    style: "minimal",
    ...
    reviews: 502,
    popularity: 95,
    badges: ["ats-optimized", "recruiter-favorite", "free"],
    isPremium: false,
    isFeatured: true,
    accent: "#6B7A63",
    ...
    layoutStyle: "Single column · tight ATS",
    bestFor: ["Anyone targeting ATS portals"],
    features: ["Zero columns risk", "Standard headings", "Fast parse"],
    readability: 97,
  },
  {
    id: "tpl_marquee",
  ...
  },
  {
    ...
    reviews: 274,
    popularity: 90,
    badges: ["recommended", "ats-optimized"],
    isPremium: false,
    accent: "#2F7A5C",
    previewAccent: "#2F7A5C",
    editorStyle: "modern",
  ...
  },
  {
    ...
    features: ["Publications block cue", "Clean degrees", "ATS safe"],
    readability: 95,
  },
  {
    id: "tpl_folio",
    name: "Folio",
    description:
      "Single-column ATS-safe layout with crisp mono score treatment.",
    style: "minimal",
    careerLevels: ["graduate", "junior", "mid-level"],
    ...
    reviews: 330,
    popularity: 86,
    badges: ["free", "ats-optimized", "popular"],
    isPremium: false,
    accent: "#1F4D3D",
    previewAccent: "#1F4D3D",
    editorStyle: "minimal",
    ...
    features: ["Mono dates", "Zero decoration risk"],
    readability: 96,
  },
  {
    id: "tpl_signal",
    ...
    features: ["High density", "Bullet scanners", "ATS keywords"],
    readability: 90,
  },
];
